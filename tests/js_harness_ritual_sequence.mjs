...
let r = await evaluateRitual([cap(1),cap(2)], {held:1,configured:1,reachable:true}, null);
...
r = await evaluateRitual([cap(1),cap(2,1),cap(3,2),cap(4,3)], {held:4,configured:4,reachable:true}, null);
...
r = await evaluateRitual([cap(1),cap(3,9)], {reachable:false}, null);
...
r = await evaluateRitual([cap(1),cap(2,1),cap(3)], {reachable:false}, null);
...
const real = [
 ...
 {capsule_id:id(2),action_type:"decide",operator:"capsule-emit-mesh-poc-demo",timestamp:"2026-08-11 06:07:11",
  ...
  assurance:{attestation_mode:"self_attested",effect_mode:"dispatched_unconfirmed",ledger_mode:"standalone"},
  model_attestation:{compute_attestation:{agent_input_digest:id(7),agent_output_digest:id(8)}}}];
const r5 = await evaluateRitual(real, {held:1,configured:1,reachable:true}, null);
...
const r6 = await evaluateRitual([{capsule_id:id(1),action_type:"decide",disposition:{decision:"reject",human_disposed:true}}], null, null);
